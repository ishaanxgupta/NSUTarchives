  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-black p-6 lg:basis-3/5">
        <h6
          className="text-2xl sm:text-3xl lg:text-5xl font-bold mb-4 text-center animate-fade-in"
          style={{
            background: "linear-gradient(to right, #007BFF, #20C997)", // Blue to Teal gradient
            WebkitBackgroundClip: "text",
            color: "transparent",
      ...
      <div className="flex-1 flex justify-center items-center bg-teal-600 p-4 lg:p-8 backdrop-blur-sm lg:basis-2/5">
        <SignIn
          ...
          appearance={{
            elements: {
              formButtonPrimary:
                "bg-teal-500 hover:bg-teal-400 text-white text-sm font-semibold py-2 px-4 rounded-md",
              formField: "text-gray-700 text-sm font-medium",
              dividerLine: "",
            },
          }}
